const Footer = () => {
  return (
    <footer>
      <div className="px-3 py-1 shadow border-t-4 flex">
        ...
        <div className="border-l-4 flex items-center flex-grow">
          <input
            type="text"
            id="default-input"
        ...
        <div className="flex items-center">
          ...
          <a href="#" className="flex items-center mx-2 border">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
